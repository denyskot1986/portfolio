...
export const productsData: ProductData[] = [
  ...
  },
  {
    ...
    name: "AI Personal Call Agent",
    tagline: "Твой переводчик-звонильщик. Говорит за тебя.",
    category: "Voice AI",
    description: "Звонит куда угодно, говорит на нужном языке, присылает транскрипцию в Telegram. $0.20/мин — без абонентки.",
    longDescription: "Решение для эмигрантов и экспатов, которым нужно позвонить в местные органы, клиники, арендодателям или в любую компанию — на языке, которого ты не знаешь. Просто напиши в Telegram что нужно сделать: ИИ-агент сам позвонит, проведёт разговор на нужном языке, спросит всё что надо и пришлёт тебе полную транскрипцию звонка текстом. Никакого стресса, никаких недопониманий. Работает на любом языке, в любую страну. Тариф: $0.20 за минуту разговора. Никакой абонентской платы.",
    features: [
      { title: "Звонок на любом языке", desc: "Агент говорит на языке страны — испанский, итальянский, немецкий, черногорский, любой другой." },
      { title: "Управление через Telegram", desc: "Напиши задачу текстом или голосом — агент сам позвонит." },
      { title: "Транскрипция звонка", desc: "Полный текст разговора приходит в Telegram сразу после завершения." },
      { title: "Без абонентки", desc: "Платишь только за минуты реального разговора. $0.20/мин." },
      { title: "Любая цель звонка", desc: "Запись к врачу, уточнение условий аренды, отмена услуги, жалоба — любая задача." },

...
export const productsData: ProductData[] = [
  {
    ...
    pricing: {
      ...
      subscription: {
        ...
        currency: "USD",
        tiers: [
          { name: "Basic", price: 149, features: ["Morning brief + inbox triage", "Meeting prep & recap", "Voice → tasks", "Personal memory"] },
          { name: "Pro", price: 299, features: ["Everything in Basic", "Opus tier (max quality)", "Unlimited messages", "Priority speed", "API + Zapier access", "Custom integrations"] },
        ],
      },
    },
  ...
  },
  {
    ...
    pricing: {
      ...
      subscription: {
        ...
        currency: "USD",
        tiers: [
          { name: "Basic", price: 299, features: ["2 voice calls per day", "Medication + health reminders", "Weekly family report", "Emergency escalation"] },
          { name: "Pro", price: 449, features: ["Everything in Basic", "Unlimited voice calls", "Smart-speaker deployment (Yandex/Google/Alice)", "Doctor's report sync via Patrik", "Priority human support"] },
        ],
      },
    },
  ...
  },
  {
    ...
    pricing: {
      ...
      subscription: {
        ...
        currency: "USD",
        tiers: [
          { name: "Basic", price: 239, features: ["Client pulse + morning brief", "Routine replies in Telegram/WhatsApp", "Weekly report", "All MCP connectors"] },
          { name: "Pro", price: 599, features: ["Everything in Basic", "Opus tier (max quality)", "Unlimited messages", "Custom MCP servers built for your stack", "Priority human support", "Quarterly tune-up session with Denys"] },
        ],
      },
    },
  ...
  },
  {
    ...
    pricing: {
      ...
      subscription: {
        ...
        currency: "USD",
        tiers: [
          { name: "Basic", price: 299, features: ["Unlimited document uploads", "Longitudinal health memory", "Pattern detection & weekly digest", "Emotional support mode", "Red-flag escalation"] },
          { name: "Pro", price: 549, features: ["Everything in Basic", "Up to 4 family members", "Shared or private vaults per person", "Priority human support", "Optional sync with Eva for aging parents"] },
        ],
      },
    },
  ...
  },
  {
    ...
    pricing: {
      ...
      subscription: {
        ...
        currency: "USD",
        tiers: [
          { name: "Basic", price: 149, features: ["1 child profile", "All ages 5–15", "Weekly parent digest", "Finekot safety stack", "EN/RU/UA/DE"] },
          { name: "Pro", price: 269, features: ["Everything in Basic", "Up to 4 child profiles", "Sibling-aware memory", "Priority human support"] },
        ],
      },
    },
    deliveryTime: { template: "Activate in 10 minutes", integration: "Subscription — no setup fee" },
  ...
  },
  {
    ...
    pricing: {
      ...
      subscription: {
        ...
        currency: "USD",
        tiers: [
          { name: "Basic", price: 149, features: ["Unlimited Fast queries", "20 Deep Research reports / mo", "Thread memory", "Markdown / Notion / Docs export"] },
          { name: "Pro", price: 299, features: ["Everything in Basic", "Unlimited Deep Research", "Opus tier (max quality)", "API access for Zapier / n8n / scripts", "Custom domain sources"] },
        ],
      },
    },
  ...
  },
  {
    ...
    pricing: {
      ...
      subscription: {
        ...
        currency: "USD",
        tiers: [
          { name: "Basic", price: 149, features: ["Voice profile from 30+ samples", "Unlimited drafts", "Multi-platform adaptation", "Anti-repeat memory"] },
          { name: "Pro", price: 389, features: ["Everything in Basic", "Up to 3 voices (team / agency)", "Calendar + approval workflow", "Engagement debrief", "Priority support"] },
        ],
      },
    },
  ...
  },
  {
    id: "factory",
    name: "Factory",
    tagline: "Builds your agent end-to-end — you pick, I ship.",
    category: "Builders",
    description: "AI-builder. Picks a base, wires your tools, tests it, deploys it — one conversation, one working agent.",
    longDescription: "Factory is the build shop behind Finekot Systems. You tell me what you need — a Boris clone tuned to your calendar, an Eva fluent in Spanish, a Taras fine-tuned for chess tutoring. I assemble it, wire in your tools, test it against 30+ edge cases, deploy it to your Telegram. No infrastructure setup, no prompt engineering on your side. One conversation, one working agent.",
    features: [
      { title: "Live assembly demo", desc: "Pick a base agent and watch me wire it together in real time — boot log, personality tuning, tool registry, deploy." },
      { title: "Custom personality", desc: "Bring your voice, tone, domain quirks. I bake them into the agent's base layer, not a surface prompt." },
      { title: "Tool wiring", desc: "Telegram, Gmail, Calendar, Notion, Shopify, your own API. I connect, authenticate, and test before handoff." },
      { title: "Edge-case hardening", desc: "Every assembled agent runs through 30+ adversarial scenarios before delivery — prompt injection, off-topic, garbage input." },
      { title: "Deploy + handoff", desc: "Final agent lands in your Telegram under your unique ID. You're the admin, you decide who else gets in." },
    ],
    useCases: [
      "Founders who need a specific AI-agent and hate configuring anything",
      "Agencies building agent stacks for their clients",
      "Teams with a workflow that doesn't fit any off-the-shelf agent",
      "Anyone who'd rather pay once than learn prompt engineering",
    ],
    techStack: [],
    pricing: { code: 1200, currency: "USD" },
    deliveryTime: { template: "Base agent assembled and delivered in 24 hours", integration: "Full custom build — 3–7 days incl. testing" },
    youtubeId: null,
    screenshots: [],
    contact: "https://t.me/shop_by_finekot_bot",
    diagram: "",
    available: true,
    firstMessage: {
      EN: "Factory here. Tell me who you need and I'll assemble it for you.",
      RU: "Factory на связи. Скажи кого собираем — соберу.",
      UA: "Factory на зв'язку. Скажи кого збираємо — зберу.",
    },
    faceConfig: { eyeStyle: "round", extra: "none" },
  },
];
...
const translations: Record<string, Record<string, ProductTranslation>> = {
  ...
  "factory": {
    RU: {
      tagline: "Собирает твоего агента под ключ — ты выбираешь, я делаю.",
      category: "Сборщики",
      description: "AI-сборщик. Выбирает базу, подключает твои инструменты, тестирует и разворачивает — один разговор, один рабочий агент.",
      longDescription: "Factory — сборочный цех Finekot Systems. Говоришь что нужно: клон Boris под твой календарь, Eva говорящая по-испански, Taras заточенный под шахматы. Я собираю, подключаю инструменты, гоняю через 30+ edge-case сценариев, разворачиваю в твой Telegram. Без инфраструктуры с твоей стороны, без prompt-инжиниринга. Один разговор — один рабочий агент.",
      features: [
        { title: "Сборка в прямом эфире", desc: "Выбираешь базового агента, смотришь как я собираю его в реальном времени — boot-лог, настройка характера, подключение инструментов, деплой." },
        { title: "Кастомный характер", desc: "Приноси свой голос, тон, особенности домена. Я вшиваю их в базовый слой агента, не в поверхностный промпт." },
        { title: "Подключение инструментов", desc: "Telegram, Gmail, Calendar, Notion, Shopify, свой API. Подключаю, авторизую, тестирую до передачи." },
        { title: "Защита от граничных случаев", desc: "Каждый собранный агент проходит 30+ adversarial-сценариев до доставки — prompt injection, off-topic, мусорный ввод." },
        { title: "Деплой и передача", desc: "Готовый агент прилетает в твой Telegram под твоим уникальным ID. Ты админ, ты решаешь кого ещё пускать." },
      ],
      useCases: ["Предприниматели которые хотят конкретного агента и ненавидят настраивать", "Агентства которые собирают AI-стеки для своих клиентов", "Команды с workflow, не укладывающимся в готового агента", "Все кто предпочитает один раз заплатить, чем учить prompt engineering"],
      deliveryTime: { template: "Базовый агент собран и доставлен за 24 часа", integration: "Полная кастомная сборка — 3–7 дней с тестированием" },
    },
    UA: {
      tagline: "Збирає твого агента під ключ — ти обираєш, я роблю.",
      category: "Складальники",
      description: "AI-складальник. Обирає базу, підключає твої інструменти, тестує та розгортає — одна розмова, один робочий агент.",
      longDescription: "Factory — складальний цех Finekot Systems. Кажеш що треба: клон Boris під твій календар, Eva, що говорить іспанською, Taras заточений під шахи. Я збираю, підключаю інструменти, ганяю через 30+ edge-case сценаріїв, розгортаю у твій Telegram. Без інфраструктури з твого боку, без prompt-інжинірингу. Одна розмова — один робочий агент.",
      features: [
        { title: "Збірка у прямому ефірі", desc: "Обираєш базового агента, дивишся як я збираю його в реальному часі — boot-лог, налаштування характеру, підключення інструментів, деплой." },
        { title: "Кастомний характер", desc: "Приноси свій голос, тон, особливості домену. Я вшиваю їх у базовий шар агента, не в поверхневий промпт." },
        { title: "Підключення інструментів", desc: "Telegram, Gmail, Calendar, Notion, Shopify, свій API. Підключаю, авторизую, тестую до передачі." },
        { title: "Захист від граничних випадків", desc: "Кожен зібраний агент проходить 30+ adversarial-сценаріїв до доставки — prompt injection, off-topic, сміттєвий ввід." },
        { title: "Деплой та передача", desc: "Готовий агент прилітає у твій Telegram під твоїм унікальним ID. Ти адмін, ти вирішуєш кого ще пускати." },
      ],
      useCases: ["Підприємці які хочуть конкретного агента і ненавидять налаштовувати", "Агенції що збирають AI-стеки для своїх клієнтів", "Команди з workflow, який не вкладається у готового агента", "Усі хто воліє раз заплатити, ніж вчити prompt engineering"],
      deliveryTime: { template: "Базовий агент зібраний і доставлений за 24 години", integration: "Повна кастомна збірка — 3–7 днів з тестуванням" },
    },
  },
};

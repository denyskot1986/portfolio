...
**ЕС:** с февраля 2025 года действует AI Act. Запрещены: скрытые манипуляции, социальный скоринг, дипфейки без маркировки. AI теперь считается «продуктом» — производитель несёт строгую ответственность за дефекты.
...
Суды в США начинают применять принцип: чем больше автономии у системы — тем выше ответственность её создателя. Это контринтуитивно для индустрии, которая продаёт автономность как фичу.
...
500 AI-стартапов. Суммарная оценка — $2,7 триллиона.

Реальная годовая выручка сектора — около $25 миллиардов.

...
[nav:/]
===
Boris — правая рука в Telegram. От $49/мес.
[scroll:product-boris]
===
Eva — AI-звонки родителям, напоминалки про лекарства. От $99/мес.
[scroll:product-eva]
===
...
Направляй когда: юзер хочет купить/оплатить/активировать, нужен custom/enterprise ($15k+), SLA/контракт/интеграция, связаться с основателем, вопрос вне каталога.

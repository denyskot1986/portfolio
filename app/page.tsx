...
const projects = [
  ...
  { id: "01", title: "SKYNET", subtitle: "Multi-Agent System", category: "Multi-Agent" as Category, status: "wip", price: "", priceNote: "Закрытое бета-тестирование", description: "Distributed army of 4 autonomous AI agents. Telegram-controlled. Three modes: Autopilot / Supervised / Manual. Each agent has memory, tools, and role isolation.", stack: ["AI API", "Telegram API", "Docker", "Python", "TypeScript"], highlights: ["4 AI agents with unique specializations", "Automatic task decomposition & delegation", "Three modes: Autopilot, Supervised, Manual", "Real-time Dashboard in Telegram"], metrics: "4 agents · 3 modes · 24/7", color: "from-pink-500/30 to-purple-500/20", accent: "border-pink-500/40", glow: "rgba(244, 114, 182, 0.3)" },
  { id: "19", title: "Reels Agent", subtitle: "Instagram AI Auto-Responder", category: "Bots" as Category, status: "wip", price: "$180", priceNote: "В тестировании", description: "AI auto-replies to every Instagram comment on your posts and reels. Sounds like you. Works 24/7. Boosts engagement by up to 3x. Buy once — your reels machine forever.", stack: ["AI API", "Instagram API", "OAuth", "Next.js", "PostgreSQL"], highlights: ["Instant AI replies to every comment", "Custom brand voice & tone settings", "Smart spam filtering & VIP escalation", "Analytics dashboard with sentiment tracking"], metrics: "24/7 · 3x engagement · your voice", color: "from-pink-500/30 to-fuchsia-500/20", accent: "border-pink-500/40", glow: "rgba(244, 114, 182, 0.3)" },
  { id: "02", title: "AI Call Agent", subtitle: "Your Personal Call Assistant", category: "Voice AI" as Category, status: "live", price: "$99", priceNote: "Source code", description: "Your AI handles every call and negotiation for you. Speaks naturally, closes deals, books meetings — you get a full Telegram transcription after each call. Never pick up the phone again.", stack: ["Whisper", "AI API", "TTS", "VoIP", "Python"], highlights: ["AI conducts calls on your behalf", "Full transcription delivered to Telegram", "Handles objections and negotiations", "Books, reschedules, confirms — autonomously"], metrics: "Full transcript · Telegram delivery", color: "from-rose-500/25 to-orange-500/15", accent: "border-rose-500/40", glow: "rgba(251, 113, 133, 0.3)" },
  { id: "03", title: "SKYNET Intake", subtitle: "AI Task Assistant", category: "Bots" as Category, status: "live", price: "$99", priceNote: "AI task routing", description: "Telegram bot converting raw ideas (text/voice) into structured Todoist tasks. AI prioritization and agent routing.", stack: ["aiogram", "AI Model", "Whisper", "Todoist API"], highlights: ["Voice input via Whisper STT", "AI task structuring & routing", "Auto-prioritization", "Todoist integration"], metrics: "Voice + text · auto-route", color: "from-fuchsia-500/25 to-pink-500/15", accent: "border-fuchsia-500/40", glow: "rgba(232, 121, 249, 0.3)" },
  { id: "20", title: "Shop_Bot (crypto)", subtitle: "Telegram Sales + Crypto", category: "Bots" as Category, status: "live", price: "$250", priceNote: "Full sales bot", description: "Telegram shopping bot with product catalog, AI sales consultant, and USDC ERC20 payment verification via Etherscan. Deep linking, multilingual (EN/RU/UA), commander notifications.", stack: ["Python", "aiogram 3", "AI API", "Etherscan", "Docker"], highlights: ["Product catalog with categories", "USDC crypto payments + auto-verify", "AI sales consultant (SPIN selling)", "Deep linking from website/ads"], metrics: "Crypto pay · AI sales · 3 langs", color: "from-emerald-500/25 to-teal-500/15", accent: "border-emerald-500/40", glow: "rgba(52, 211, 153, 0.3)" },
  { id: "21", title: "Salon Call Bot", subtitle: "AI Phone Agent", category: "Voice AI" as Category, status: "live", price: "$249", priceNote: "Source code", description: "AI voice agent that makes real outbound phone calls. Confirm appointments, send reminders, reschedule — all via natural voice dialogue. Controlled from Telegram.", stack: ["Python", "Twilio", "Whisper", "AI API", "ElevenLabs"], highlights: ["Real outbound phone calls", "Natural voice (ElevenLabs)", "Pre-built salon scenarios", "Telegram control + transcripts"], metrics: "Real calls · natural voice", color: "from-rose-500/25 to-orange-500/15", accent: "border-rose-500/40", glow: "rgba(251, 113, 133, 0.3)" },
  { id: "22", title: "Bot Factory", subtitle: "Multi-Tenant Bot Platform", category: "Multi-Agent" as Category, status: "wip", price: "$699", priceNote: "В тестировании", description: "One deployment, unlimited AI bots. Multi-tenant architecture with per-client config, AI model selection, analytics dashboard, and REST admin API. Hybrid mode: clients bring their own bot token.", stack: ["Python", "FastAPI", "aiogram 3", "SQLite", "OpenRouter"], highlights: ["Unlimited client bots from 1 deployment", "Per-client AI config & limits", "Admin REST API (FastAPI)", "Hybrid mode: own bot tokens"], metrics: "∞ bots · 1 deploy · API", color: "from-violet-500/25 to-purple-500/15", accent: "border-violet-500/40", glow: "rgba(167, 139, 250, 0.3)" },
  { id: "23", title: "Reels Factory", subtitle: "AI Video Production", category: "Automation" as Category, status: "wip", price: "$699", priceNote: "В разработке", description: "Photo + text → Instagram Reel with lip-sync, voice clone, and auto-subtitles. Send media to Telegram bot, get back finished 9:16 video ready to post.", stack: ["Python", "ElevenLabs", "Sync Labs", "FFmpeg", "Telegram"], highlights: ["Voice clone TTS (ElevenLabs)", "Lip-sync video (Sync Labs)", "Auto-subtitles from script", "9:16 Instagram-ready output"], metrics: "Photo → Reel · lip-sync", color: "from-pink-500/25 to-fuchsia-500/15", accent: "border-pink-500/40", glow: "rgba(244, 114, 182, 0.3)" },

  // ═══ IN PROGRESS — by interest level ═══
  { id: "04", title: "AI-Admin", subtitle: "AI Business Manager", category: "Automation" as Category, status: "wip", price: "$1900", priceNote: "Закрытое бета-тестирование", description: "Autonomous AI manager for beauty salon. Handles hiring, clients, supply chain, communications, reports — fully on autopilot.", stack: ["AI API", "Telegram", "Telethon", "PostgreSQL"], highlights: ["Auto-hiring & staff management", "Client acquisition on autopilot", "Supply chain management", "Daily business reports"], metrics: "Full autopilot · 24/7", color: "from-pink-400/25 to-amber-500/10", accent: "border-pink-400/40", glow: "rgba(244, 114, 182, 0.25)" },
  { id: "18", title: "C-Admin", subtitle: "Universal Client Manager", category: "Bots" as Category, status: "wip", price: "$299", priceNote: "В тестировании", description: "AI admin for any service professional. Handles bookings, client management, auto-marketing — all from Telegram. Lite version of AI-Admin.", stack: ["AI API", "Telegram Bot API", "PostgreSQL", "N8N", "Redis"], highlights: ["Smart booking & scheduling", "Client CRM with history", "Auto-marketing & promotions", "Multi-channel communication"], metrics: "Lite · any profession", color: "from-indigo-400/25 to-blue-500/15", accent: "border-indigo-400/40", glow: "rgba(129, 140, 248, 0.25)" },
  { id: "06", title: "LeadHunter AI", subtitle: "Lead Qualification Bot", category: "Bots" as Category, status: "wip", price: "$200", priceNote: "Скоро в продаже", description: "WhatsApp/Telegram lead qualification using BANT methodology. Scores 1–10, auto-syncs hot leads to CRM with full conversation context.", stack: ["AI API", "aiogram", "WhatsApp API", "HubSpot", "PostgreSQL"], highlights: ["Intelligent BANT qualification", "Lead scoring 1–10 scale", "Auto-push to HubSpot / Bitrix", "Hot lead alerts to manager"], metrics: "BANT scoring · CRM sync", color: "from-orange-500/25 to-rose-500/15", accent: "border-orange-500/40", glow: "rgba(249, 115, 22, 0.3)" },
  { id: "08", title: "ContentFactory", subtitle: "AI Content Automation", category: "Automation" as Category, status: "wip", price: "$500", priceNote: "Скоро в продаже", description: "N8N pipeline: one idea → 10 posts adapted for Instagram, LinkedIn, Telegram, Twitter in the right brand tone and format.", stack: ["N8N", "AI API", "OpenAI", "Airtable", "Make"], highlights: ["Brief → ready posts in minutes", "Adapts tone per platform", "Auto-scheduling via Buffer", "Monthly content plan in 5 min"], metrics: "1 idea → 10 posts", color: "from-emerald-500/20 to-teal-500/10", accent: "border-emerald-500/30", glow: "rgba(52, 211, 153, 0.25)" },
  { id: "05", title: "DocMind", subtitle: "RAG Knowledge Base", category: "RAG" as Category, status: "live", price: "$200", priceNote: "Source code", description: "Enterprise knowledge base: upload PDF, DOCX, URLs, Notion — get AI assistant that answers with inline source citations.", stack: ["AI API", "LangChain", "ChromaDB", "FastAPI", "Next.js"], highlights: ["Supports PDF, DOCX, URL, Notion", "Semantic search across documents", "Answers with inline citations", "Ready widget for site / Telegram"], metrics: "4 doc types · cited answers", color: "from-violet-500/25 to-pink-500/15", accent: "border-violet-500/40", glow: "rgba(167, 139, 250, 0.3)" },
  { id: "07", title: "SupportBot Pro", subtitle: "AI Customer Support", category: "Bots" as Category, status: "live", price: "$200", priceNote: "Source code", description: "First-line support agent trained on historical tickets. Handles 10+ languages. Escalates complex cases to humans with full context.", stack: ["AI API", "RAG", "Telegram", "Zendesk API", "Python"], highlights: ["Trained on historical tickets & FAQ", "Smart escalation with context", "10+ languages supported", "Zendesk / Intercom / Freshdesk"], metrics: "10+ langs · smart escalation", color: "from-cyan-500/20 to-blue-500/10", accent: "border-cyan-500/30", glow: "rgba(34, 211, 238, 0.25)" },
  { id: "12", title: "Hiring Autopilot", subtitle: "AI Recruitment Agent", category: "Multi-Agent" as Category, status: "wip", price: "$199", priceNote: "Скоро в продаже", description: "Multi-agent recruitment pipeline: screens 100+ resumes, conducts async chat interviews, AI-scores candidates, books finals automatically.", stack: ["AI API", "aiogram", "PostgreSQL", "Google Calendar", "Python"], highlights: ["Screen 100+ resumes in minutes", "Async interview via Telegram/Web", "AI scoring by custom criteria", "Auto-booking of final interviews"], metrics: "100+ resumes/min · auto-book", color: "from-indigo-500/25 to-purple-500/15", accent: "border-indigo-500/40", glow: "rgba(139, 92, 246, 0.3)" },
  { id: "11", title: "Contract Scanner", subtitle: "AI Legal Review", category: "RAG" as Category, status: "live", price: "$100", priceNote: "Source code", description: "Upload any contract — get risk analysis, red flags, clause comparison against templates, and plain-language summary in 30 seconds.", stack: ["AI API", "LangChain", "ChromaDB", "FastAPI", "Next.js"], highlights: ["Risk & red flag analysis in 30s", "Compare against template standards", "Highlights dangerous clauses", "Plain-language summary"], metrics: "30s analysis · red flags", color: "from-blue-500/25 to-indigo-500/15", accent: "border-blue-500/40", glow: "rgba(59, 130, 246, 0.3)" },
  { id: "09", title: "RealEstate AI", subtitle: "Property Assistant Bot", category: "Bots" as Category, status: "wip", price: "$1200", priceNote: "В разработке", description: "AI agent for real estate. Matches properties by parameters, answers questions 24/7, books viewings in Google Calendar, updates CRM.", stack: ["AI API", "Telegram", "PostgreSQL", "Google Calendar", "Python"], highlights: ["Smart matching by parameters", "24/7 Q&A about listings", "Viewing booking in Calendar", "CRM updates & agent alerts"], metrics: "Smart match · auto-booking", color: "from-amber-500/20 to-orange-500/10", accent: "border-amber-500/30", glow: "rgba(245, 158, 11, 0.25)" },
  { id: "13", title: "BizPulse", subtitle: "Business Intelligence Agent", category: "Automation" as Category, status: "wip", price: "$200", priceNote: "В разработке", description: "AI monitors revenue, CAC, LTV and conversion — auto-diagnoses anomalies and sends Telegram alerts with root cause analysis.", stack: ["AI API", "N8N", "PostgreSQL", "Metabase", "Telegram"], highlights: ["Connects to DB / Sheets / Metabase", "Daily AI metric digest", "Alert on anomaly detection", "Root cause AI diagnosis"], metrics: "Real-time · root cause AI", color: "from-teal-500/25 to-cyan-500/15", accent: "border-teal-500/40", glow: "rgba(20, 184, 166, 0.3)" },
  { id: "10", title: "MailMind", subtitle: "AI Email Automation", category: "Automation" as Category, status: "live", price: "$100", priceNote: "Source code", description: "AI email processing: classifies inbound, prioritizes, drafts replies in 3 seconds, auto-sends standard responses, escalates edge cases.", stack: ["AI API", "N8N", "Gmail API", "OpenAI", "Supabase"], highlights: ["Auto-classification of inbound", "Draft reply in 3 seconds", "Auto-sends FAQ responses", "Smart escalation of edge cases"], metrics: "3s draft · auto-classify", color: "from-pink-400/20 to-purple-400/10", accent: "border-pink-400/30", glow: "rgba(236, 72, 153, 0.25)" },
  { id: "14", title: "CodeReviewer", subtitle: "Autonomous Code Review Agent", category: "Multi-Agent" as Category, status: "live", price: "$100", priceNote: "Source code", description: "Autonomous code review agent. Analyzes PRs for bugs, security vulns, performance issues. Writes inline comments. Learns team conventions.", stack: ["AI API", "GitHub API", "AST Parsers", "Python", "Docker"], highlights: ["PR analysis < 60 seconds", "OWASP security checks", "Learns team coding style", "Inline comments like a human"], metrics: "< 60s · OWASP · style learning", color: "from-lime-500/25 to-emerald-500/15", accent: "border-lime-500/40", glow: "rgba(132, 204, 22, 0.3)" },
  { id: "16", title: "Meeting Scribe", subtitle: "AI Meeting Assistant", category: "Voice AI" as Category, status: "wip", price: "$199", priceNote: "Закрытое бета-тестирование", description: "Records meetings via bot, transcribes, extracts action items, assigns owners, pushes tasks to project management tools automatically.", stack: ["Whisper", "AI API", "Zoom SDK", "Notion API", "Python"], highlights: ["Live meeting transcription", "Action item extraction", "Auto-assign to owners", "Push to Notion / Todoist"], metrics: "Live transcription · auto-assign", color: "from-rose-500/25 to-pink-500/15", accent: "border-rose-500/40", glow: "rgba(244, 63, 94, 0.3)" },
  { id: "17", title: "Compliance Guard", subtitle: "Regulatory Compliance AI", category: "RAG" as Category, status: "wip", price: "$399", priceNote: "В разработке", description: "Regulatory compliance checker. Upload policies + new docs — AI flags violations, suggests fixes, tracks compliance score over time.", stack: ["AI API", "LangChain", "Pinecone", "FastAPI", "React"], highlights: ["Multi-regulation checking", "Compliance scoring with history", "Fix suggestions per violation", "Full audit trail"], metrics: "Multi-reg · audit trail", color: "from-yellow-500/25 to-amber-500/15", accent: "border-yellow-500/40", glow: "rgba(234, 179, 8, 0.3)" },
];
      ...
      <footer className="relative z-10 py-8 border-t border-pink-500/10 font-mono">
        <div className="max-w-5xl mx-auto px-6 flex flex-col items-center gap-4">
          <div className="flex flex-wrap justify-center gap-6">
            <a href="https://instagram.com/finekot.ai" target="_blank" rel="noopener noreferrer" className="text-xs text-pink-300/35 hover:text-pink-300/70 transition-colors tracking-wider font-mono">
              Instagram — @finekot.ai
            </a>
            <a href="https://t.me/finekot_ai" target="_blank" rel="noopener noreferrer" className="text-xs text-pink-300/35 hover:text-pink-300/70 transition-colors tracking-wider font-mono">
              Telegram EN — @finekot_ai
            </a>
            <a href="https://t.me/finekot_ai_ua" target="_blank" rel="noopener noreferrer" className="text-xs text-pink-300/35 hover:text-pink-300/70 transition-colors tracking-wider font-mono">
              Telegram UA — @finekot_ai_ua
            </a>
            <a href="https://t.me/finekot_ai_ru" target="_blank" rel="noopener noreferrer" className="text-xs text-pink-300/35 hover:text-pink-300/70 transition-colors tracking-wider font-mono">

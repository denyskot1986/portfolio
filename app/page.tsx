...
const projects = [
  ...
  { id: "08", title: "ContentFactory", subtitle: "AI Content Automation", category: "Automation" as Category, status: "wip", price: "$500", priceNote: "Скоро в продаже", description: "N8N pipeline: one idea → 10 posts adapted for Instagram, LinkedIn, Telegram, Twitter in the right brand tone and format.", stack: ["N8N", "Claude API", "OpenAI", "Airtable", "Make"], highlights: ["Brief → ready posts in minutes", "Adapts tone per platform", "Auto-scheduling via Buffer", "Monthly content plan in 5 min"], metrics: "1 idea → 10 posts", color: "from-emerald-500/20 to-teal-500/10", accent: "border-emerald-500/30", glow: "rgba(52, 211, 153, 0.25)" },
  { id: "05", title: "DocMind", subtitle: "RAG Knowledge Base", category: "RAG" as Category, status: "live", price: "$200", priceNote: "Source code", description: "Enterprise knowledge base: upload PDF, DOCX, URLs, Notion — get AI assistant that answers with inline source citations.", stack: ["Claude API", "LangChain", "ChromaDB", "FastAPI", "Next.js"], highlights: ["Supports PDF, DOCX, URL, Notion", "Semantic search across documents", "Answers with inline citations", "Ready widget for site / Telegram"], metrics: "4 doc types · cited answers", color: "from-violet-500/25 to-pink-500/15", accent: "border-violet-500/40", glow: "rgba(167, 139, 250, 0.3)" },
  { id: "07", title: "SupportBot Pro", subtitle: "AI Customer Support", category: "Bots" as Category, status: "live", price: "$200", priceNote: "Source code", description: "First-line support agent trained on historical tickets. Handles 10+ languages. Escalates complex cases to humans with full context.", stack: ["Claude API", "RAG", "Telegram", "Zendesk API", "Python"], highlights: ["Trained on historical tickets & FAQ", "Smart escalation with context", "10+ languages supported", "Zendesk / Intercom / Freshdesk"], metrics: "10+ langs · smart escalation", color: "from-cyan-500/20 to-blue-500/10", accent: "border-cyan-500/30", glow: "rgba(34, 211, 238, 0.25)" },
  ...
  { id: "09", title: "RealEstate AI", subtitle: "Property Assistant Bot", category: "Bots" as Category, status: "wip", price: "$1200", priceNote: "В разработке", description: "AI agent for real estate. Matches properties by parameters, answers questions 24/7, books viewings in Google Calendar, updates CRM.", stack: ["Claude API", "Telegram", "PostgreSQL", "Google Calendar", "Python"], highlights: ["Smart matching by parameters", "24/7 Q&A about listings", "Viewing booking in Calendar", "CRM updates & agent alerts"], metrics: "Smart match · auto-booking", color: "from-amber-500/20 to-orange-500/10", accent: "border-amber-500/30", glow: "rgba(245, 158, 11, 0.25)" },
  { id: "13", title: "BizPulse", subtitle: "Business Intelligence Agent", category: "Automation" as Category, status: "wip", price: "$200", priceNote: "В разработке", description: "AI monitors revenue, CAC, LTV and conversion — auto-diagnoses anomalies and sends Telegram alerts with root cause analysis.", stack: ["Claude API", "N8N", "PostgreSQL", "Metabase", "Telegram"], highlights: ["Connects to DB / Sheets / Metabase", "Daily AI metric digest", "Alert on anomaly detection", "Root cause AI diagnosis"], metrics: "Real-time · root cause AI", color: "from-teal-500/25 to-cyan-500/15", accent: "border-teal-500/40", glow: "rgba(20, 184, 166, 0.3)" },

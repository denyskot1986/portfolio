...
const projects = [
  ...
  { id: "05", title: "DocMind", subtitle: "RAG Knowledge Base", category: "RAG" as Category, status: "wip", price: "$200", priceNote: "Скоро в продаже", description: "Enterprise knowledge base: upload PDF, DOCX, URLs, Notion — get AI assistant that answers with inline source citations.", stack: ["Claude API", "LangChain", "ChromaDB", "FastAPI", "Next.js"], highlights: ["Supports PDF, DOCX, URL, Notion", "Semantic search across documents", "Answers with inline citations", "Ready widget for site / Telegram"], metrics: "4 doc types · cited answers", color: "from-violet-500/25 to-pink-500/15", accent: "border-violet-500/40", glow: "rgba(167, 139, 250, 0.3)" },
  { id: "07", title: "SupportBot Pro", subtitle: "AI Customer Support", category: "Bots" as Category, status: "wip", price: "$200", priceNote: "Скоро в продаже", description: "First-line support agent trained on historical tickets. Handles 10+ languages. Escalates complex cases to humans with full context.", stack: ["Claude API", "RAG", "Telegram", "Zendesk API", "Python"], highlights: ["Trained on historical tickets & FAQ", "Smart escalation with context", "10+ languages supported", "Zendesk / Intercom / Freshdesk"], metrics: "10+ langs · smart escalation", color: "from-cyan-500/20 to-blue-500/10", accent: "border-cyan-500/30", glow: "rgba(34, 211, 238, 0.25)" },

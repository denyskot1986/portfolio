...
const tr = {
  en: {
    ...
    plans: [
      { name: "Starter", price: "$89", desc: "For creators getting started", features: ["1 Instagram account", "500 auto-replies/mo", "Basic tone settings", "Email support"] },
      { name: "Pro", price: "$239", desc: "For serious creators & brands", features: ["3 Instagram accounts", "Unlimited auto-replies", "Advanced voice & tone", "Priority support", "Analytics dashboard", "Banned topics filter"] },
      { name: "Agency", price: "$599", desc: "For agencies managing clients", features: ["10 Instagram accounts", "Unlimited everything", "White-label option", "API access", "Dedicated account manager", "Custom AI training"] },
    ],
  ...
  ru: {
    ...
    plans: [
      { name: "Starter", price: "$89", desc: "Для начинающих креаторов", features: ["1 аккаунт Instagram", "500 авто-ответов/мес", "Базовые настройки тона", "Email поддержка"] },
      { name: "Pro", price: "$239", desc: "Для серьёзных креаторов и брендов", features: ["3 аккаунта Instagram", "Безлимит авто-ответов", "Продвинутый голос и тон", "Приоритетная поддержка", "Аналитический дашборд", "Фильтр запретных тем"] },
      { name: "Agency", price: "$599", desc: "Для агентств", features: ["10 аккаунтов Instagram", "Безлимит всего", "White-label", "API доступ", "Персональный менеджер", "Кастомная AI-настройка"] },
    ],
  ...
  ua: {
    ...
    plans: [
      { name: "Starter", price: "$89", desc: "Для креаторів-початківців", features: ["1 акаунт Instagram", "500 авто-відповідей/міс", "Базові налаштування тону", "Email підтримка"] },
      { name: "Pro", price: "$239", desc: "Для серйозних креаторів та брендів", features: ["3 акаунти Instagram", "Безліміт авто-відповідей", "Просунутий голос і тон", "Пріоритетна підтримка", "Аналітичний дашборд", "Фільтр заборонених тем"] },
      { name: "Agency", price: "$599", desc: "Для агенцій", features: ["10 акаунтів Instagram", "Безліміт всього", "White-label", "API доступ", "Персональний менеджер", "Кастомне AI-налаштування"] },
    ],
